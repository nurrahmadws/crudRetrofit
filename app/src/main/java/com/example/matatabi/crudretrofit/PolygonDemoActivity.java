...
public class PolygonDemoActivity extends AppCompatActivity implements OnSeekBarChangeListener, OnItemSelectedListener, OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMutablePolygon = googleMap.addPolygon(new PolygonOptions()
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(CENTER, 4));
    ...
    private int getSelectedJointType(int pos) {
        switch (JOINT_TYPE_NAME_RESOURCE_IDS[pos]) {
            case R.string.joint_type_bevell:
